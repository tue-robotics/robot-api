...
/* eslint-disable @stylistic/key-spacing, @stylistic/no-multi-spaces, camelcase -- table columns are aligned for readability and ROS parts use snake_case */
...
const properties = {};
for (const [name, v] of Object.entries(propertiesTable)) {
  properties[name] = {
    homeable: v[0],
