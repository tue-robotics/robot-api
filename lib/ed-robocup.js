...
export default class EdRobocup extends Ed {
  ...
  /**
   World model fitting
   @param {string} model_name Type of the model to fit
   @param {number} px Horizontal click position as a ratio of the image width
   @param {number} py Vertical click position as a ratio of the image height
   */
  fit_model(model_name, px, py) {
    const request = {
      /* eslint camelcase:0 -- ROS message fields use snake_case */
